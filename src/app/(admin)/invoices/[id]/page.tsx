                                    ...
                                    <tbody>
                                        ...
                                        {invoice.medications.map((medication, index) => (
                                            <tr key={`medication-${medication.id}`}>
                                                <td className="border border-gray-800 px-2 py-1 text-center">{invoice.services.length + index + 1}</td>
                                        ...
                                        <tr className="font-bold">
                                            <td colSpan={4} className="border border-gray-800 px-2 py-2 text-right">
                                                Tổng cộng
                                            </td>
