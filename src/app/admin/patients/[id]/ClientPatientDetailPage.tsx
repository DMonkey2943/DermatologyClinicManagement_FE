...
import { Calendar, Mail, MapPin, Phone, Heart, AlertTriangle, IdCard, VenusAndMars, Edit } from 'lucide-react';
            ...
            <div className="grid grid-cols-12 gap-4 md:gap-6">
                <div className="col-span-12 xl:col-span-5">
                    <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-gray-900/70">
                        ...
                        {/* NÚT CẬP NHẬT THÔNG TIN - Góc dưới bên phải */}
                        <div className="mt-6 flex justify-end">
                        <Link
                            href={getPrefixedPath(`/patients/${patient?.id}/edit`, user?.role)}
                            className="inline-flex items-center gap-2 rounded-lg bg-yellow-400 px-4 py-2.5 text-sm font-medium text-white shadow-md transition-all hover:bg-yellow-500 hover:shadow-lg active:scale-95 dark:bg-yellow-500 dark:hover:bg-yellow-600"
                        >
